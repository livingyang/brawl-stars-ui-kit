import{i as e}from"./preload-helper-CeV3c4x5.js";import{D as t,O as n,S as r,b as i,f as a,g as o,k as s,p as c,u as l}from"./iframe-DVF5ZnWA.js";import{a as u,c as d,i as f,n as p,o as m,r as h,t as g}from"./_plugin-vue_export-helper-Dw-_KY5i.js";var _,v,y,b=e((()=>{l(),d(),_=[`disabled`],v={class:`label`},y=i({__name:`BsTabButton`,props:{label:{},active:{type:Boolean,default:!1},disabled:{type:Boolean,default:!1}},setup(e){let i=e,l=a(()=>{let e={"--bs-yellow":u.yellow,"--bs-white":u.white,"--bs-black":u.black,"--bs-gray600":u.gray600,"--bs-border-width":f.width,"--bs-border-radius":f.radius.md,"--bs-font-size":m.sizes.md,"--bs-font-weight":String(m.weights.bold),"--bs-animation-fast":h.fast};return i.disabled?(e.opacity=`0.5`,e.cursor=`not-allowed`):e.cursor=`pointer`,e});return(i,a)=>(r(),o(`button`,{class:t([`bs-tab-button`,{active:e.active}]),style:n(l.value),disabled:e.disabled},[c(`span`,v,s(e.label),1)],14,_))}})})),x=e((()=>{})),S,C=e((()=>{b(),b(),x(),p(),S=g(y,[[`__scopeId`,`data-v-1ecd959d`]]),y.__docgenInfo=Object.assign({displayName:y.name??y.__name},{exportName:`default`,displayName:`BsTabButton`,description:``,tags:{},props:[{name:`label`,required:!0,type:{name:`string`}},{name:`active`,required:!1,type:{name:`boolean`},defaultValue:{func:!1,value:`false`}},{name:`disabled`,required:!1,type:{name:`boolean`},defaultValue:{func:!1,value:`false`}}],sourceFiles:[`/home/runner/work/brawl-stars-ui-kit/brawl-stars-ui-kit/src/components/atoms/BsTabButton.vue`]})})),w,T,E,D,O,k;e((()=>{C(),w={title:`Atoms/BsTabButton`,component:S,tags:[`autodocs`],argTypes:{label:{control:`text`,description:`Tab label text`},active:{control:`boolean`,description:`Active state`},disabled:{control:`boolean`,description:`Disabled state`}},parameters:{layout:`centered`,backgrounds:{default:`dark`,values:[{name:`dark`,value:`#1A1A2E`},{name:`light`,value:`#F5F5F5`}]}}},T={args:{label:`BRAWLERS`,active:!1,disabled:!1}},E={args:{label:`BRAWLERS`,active:!0,disabled:!1}},D={args:{label:`BRAWLERS`,active:!1,disabled:!0}},O={render:()=>({components:{BsTabButton:S},template:`

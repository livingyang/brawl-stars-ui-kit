import{i as e}from"./preload-helper-CT_b8DTk.js";import{n as t,t as n}from"./BsSecondaryButton-DYcyefM7.js";var r,i,a,o,s,c,l;e((()=>{t(),r={title:`Basics/BsSecondaryButton`,component:n,tags:[`autodocs`],argTypes:{label:{control:`text`,description:`Button label text`},disabled:{control:`boolean`,description:`Disabled state`},size:{control:`select`,options:[`large`,`medium`,`small`],description:`Button size`}},parameters:{layout:`centered`,backgrounds:{default:`dark`,values:[{name:`dark`,value:`#1A1A2E`},{name:`light`,value:`#F5F5F5`}]}}},i={args:{label:`EXIT`,disabled:!1,size:`medium`}},a={args:{label:`EXIT`,disabled:!0,size:`medium`}},o={args:{label:`TRY BRAWLER`,disabled:!1,size:`large`}},s={args:{label:`OK`,disabled:!1,size:`small`}},c={render:()=>({components:{BsSecondaryButton:n},template:`

import{i as e}from"./preload-helper-CT_b8DTk.js";import{n as t,t as n}from"./BsPrimaryButton-Ch5hLTPQ.js";var r,i,a,o,s,c,l;e((()=>{t(),r={title:`Basics/BsPrimaryButton`,component:n,tags:[`autodocs`],argTypes:{label:{control:`text`,description:`Button label text`},disabled:{control:`boolean`,description:`Disabled state`},locked:{control:`boolean`,description:`Locked state`},size:{control:`select`,options:[`large`,`medium`],description:`Button size`}},parameters:{layout:`centered`,backgrounds:{default:`dark`,values:[{name:`dark`,value:`#1A1A2E`},{name:`light`,value:`#F5F5F5`}]}}},i={args:{label:`PLAY`,disabled:!1,locked:!1,size:`large`}},a={args:{label:`PLAY`,disabled:!0,locked:!1,size:`large`}},o={args:{label:`UNLOCK`,disabled:!1,locked:!0,size:`large`}},s={args:{label:`SELECT`,disabled:!1,locked:!1,size:`medium`}},c={render:()=>({components:{BsPrimaryButton:n},template:`

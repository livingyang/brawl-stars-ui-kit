import{i as e}from"./preload-helper-CT_b8DTk.js";import{D as t,O as n,S as r,T as i,b as a,f as o,g as s,k as c,p as l,u}from"./iframe-CJm2Q8zN.js";import{a as d,c as f,i as p,n as m,o as h,r as g,s as _,t as v}from"./_plugin-vue_export-helper-yTqPlQ-I.js";var y,b,x,S,C=e((()=>{u(),f(),y=[`disabled`,`aria-label`],b={class:`reward-icon`},x={class:`label`},S=a({__name:`BsRewardButton`,props:{label:{},locked:{type:Boolean,default:!1},glow:{type:Boolean,default:!1},ariaLabel:{}},setup(e){let a=e,u=i(!1),f=i(!1),m=o(()=>{let e={"--bs-green":d.green,"--bs-yellow":d.yellow,"--bs-yellow-light":d.yellowLight,"--bs-black":d.black,"--bs-white":d.white,"--bs-border-width":p.width,"--bs-border-radius":p.radius.md,"--bs-font-size":h.sizes.lg,"--bs-font-weight":String(h.weights.bold),"--bs-animation-fast":g.fast,"--bs-transform-hover":_.hover,"--bs-transform-active":_.active};return a.locked?e.cursor=`not-allowed`:e.cursor=`pointer`,e}),v=o(()=>a.ariaLabel||a.label),S=()=>{a.locked||(u.value=!0)},C=()=>{u.value=!1,f.value=!1},w=()=>{a.locked||(f.value=!0)},T=()=>{f.value=!1};return(i,a)=>(r(),s(`button`,{class:t([`bs-reward-button`,{locked:e.locked,glow:e.glow}]),style:n(m.value),disabled:e.locked,"aria-label":v.value,onMouseenter:S,onMouseleave:C,onMousedown:w,onMouseup:T},[l(`span`,b,c(e.locked?`🔒`:`⭐`),1),l(`span`,x,c(e.label),1)],46,y))}})})),w=e((()=>{})),T,E=e((()=>{C(),C(),w(),m(),T=v(S,[[`__scopeId`,`data-v-cb35a06d`]]),S.__docgenInfo=Object.assign({displayName:S.name??S.__name},{exportName:`default`,displayName:`BsRewardButton`,description:``,tags:{},props:[{name:`label`,required:!0,type:{name:`string`}},{name:`locked`,required:!1,type:{name:`boolean`},defaultValue:{func:!1,value:`false`}},{name:`glow`,required:!1,type:{name:`boolean`},defaultValue:{func:!1,value:`false`}},{name:`ariaLabel`,required:!1,type:{name:`string`}}],sourceFiles:[`/home/runner/work/brawl-stars-ui-kit/brawl-stars-ui-kit/src/components/atoms/BsRewardButton.vue`]})})),D,O,k,A,j,M;e((()=>{E(),D={title:`Atoms/BsRewardButton`,component:T,tags:[`autodocs`],argTypes:{label:{control:`text`,description:`Button label text`},locked:{control:`boolean`,description:`Locked state`},glow:{control:`boolean`,description:`Glow animation effect`}},parameters:{layout:`centered`,backgrounds:{default:`dark`,values:[{name:`dark`,value:`#1A1A2E`},{name:`light`,value:`#F5F5F5`}]}}},O={args:{label:`CLAIM`,locked:!1,glow:!1}},k={args:{label:`UNLOCK`,locked:!0,glow:!1}},A={args:{label:`CLAIM`,locked:!1,glow:!0}},j={render:()=>({components:{BsRewardButton:T},template:`

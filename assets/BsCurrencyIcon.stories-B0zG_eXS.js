import{i as e}from"./preload-helper-CT_b8DTk.js";import{n as t,t as n}from"./BsCurrencyIcon-BS2zFv2m.js";var r,i,a,o,s,c,l,u,d;e((()=>{t(),r={title:`Basics/BsCurrencyIcon`,component:n,tags:[`autodocs`],argTypes:{currencyType:{control:`select`,options:[`coins`,`gems`,`powerpoints`,`trophies`,`starrrops`],description:`Currency type`},size:{control:`select`,options:[`small`,`medium`,`large`],description:`Icon size`}},parameters:{layout:`centered`,backgrounds:{default:`dark`,values:[{name:`dark`,value:`#1A1A2E`},{name:`light`,value:`#F5F5F5`}]}}},i={args:{currencyType:`coins`,size:`medium`}},a={args:{currencyType:`gems`,size:`medium`}},o={args:{currencyType:`powerpoints`,size:`medium`}},s={args:{currencyType:`trophies`,size:`medium`}},c={args:{currencyType:`starrrops`,size:`medium`}},l={render:()=>({components:{BsCurrencyIcon:n},template:`
